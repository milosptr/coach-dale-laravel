        ...
        <div class="container mx-auto py-20 max-w-7xl">
          ...
          <div class="flex flex-wrap justify-center">
            <div class="w-full sm:w-1/2">
              <div class="h-full flex sm:mr-5 border border-solid border-red-500 rounded-md py-3 px-8" style="border-color: rgb(239, 68, 68)!important;     box-shadow: 1px 3px 14px #f13b51;">
                <div class="">
            ...
            <div class="w-full sm:w-1/2 mt-10 sm:mt-0">
              <div class="h-full flex sm:ml-5 border border-solid border-red-500 rounded-md py-3 px-8" style="border-color: rgb(239, 68, 68)!important;     box-shadow: 1px 3px 14px #f13b51;">
                <div class="">
            ...
            <div class="w-full sm:w-1/2 mt-10">
              <div class="h-full flex border sm:ml-5 border-solid border-red-500 rounded-md py-3 px-8" style="border-color: rgb(239, 68, 68)!important;     box-shadow: 1px 3px 14px #f13b51;">
                <div class="">
            ...
            <div class="w-full sm:w-1/2 mt-10">
              <div class="flex border border-solid border-red-500 rounded-md py-3 px-8" style="border-color: rgb(239, 68, 68)!important;     box-shadow: 1px 3px 14px #f13b51;">
                <div class="">
                  ...
                  <p class="text-lg font-medium mt-3 pl-5">— Mirjana - Personal 101</p>
                </div>
              </div>
            </div>
          </div>
